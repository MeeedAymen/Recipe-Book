...
<html lang="en">
    ...
    <body class="mb-48">
        ...
        <footer class="fixed bottom-0 left-0 w-full flex items-center justify-start font-bold bg-blue-900 text-white h-24 mt-24 opacity-90 md:justify-center">
    ...
    <body class="mb-48">
        <nav class="flex justify-between items-center mb-4 bg-blue-900 text-white">
            ...
            <ul class="flex space-x-6 mr-6 text-lg">
                <li>
                    <a href="register.html" class="hover:text-blue-300"><i class="fa-solid fa-user-plus"></i> Register</a>
                </li>
                <li>
                    <a href="login.html" class="hover:text-blue-300"><i class="fa-solid fa-arrow-right-to-bracket"></i>Login</a>
                </li>
            </ul>
        </nav>
        

        <section class="relative h-72 bg-sky-300 flex flex-col justify-center align-center text-center space-y-4 mb-4">
            ...
            <div class="z-10">
                <h1 class="text-4xl font-bold uppercase text-white">
                    Recipe<span class="text-blue-900">Book</span>
                </h1>
                <p class="text-2xl text-blue-900 font-bold my-4">
                    Find all recipes
                </p>
            </div>
        </section>
        <main>
                ...
                <form action="{{ route('recipes.search') }}">
                    <div class="relative border-2 border-gray-100 m-4 rounded-lg">
                        ...
                        <div class="absolute top-2 right-2">
                            <button type="submit"class="h-10 w-20 text-white rounded-lg bg-blue-900 hover:bg-blue-700">
                                Search
                            </button>
                        </div>
                    </div>
                    <center>
                        <a href="{{ url('/add') }}" class="bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Product</a>
                         </center>
                </form>
                @if($data->isEmpty())
            ...
            @foreach($data as $recipe)
                    ...
                    <div class="flex justify-center mt-4">
                    <a class="bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2" href="{{ route('update_recipe',['id'=>$recipe->id])}}">Update</a>
                    <a  class="bg-blue-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href="{{ route('delete_recipe',['id'=>$recipe->id]) }}">Delete</a>
                    </div>
                    <br>
                @endforeach
        </main>
